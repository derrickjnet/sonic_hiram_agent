...
rewards_list = pd.DataFrame(gb('rewards').game_rewards(list)).drop_duplicates()
reward_std = rewards_list.std()
reward_mean = rewards_list.mean()
rewards_25 = rewards_list.quantile(q=.25)
rewards_50 = rewards_list.quantile(q=.50)
rewards_75 = rewards_list.quantile(q=.75)
rewards_change = rewards_list.pct_change

print(reward_std,reward_mean,rewards_25,rewards_50,rewards_75)
